  ...
  return (
    <div className="min-h-screen spiritual-page-bg relative overflow-hidden">
      ...
      <Routes>
        ...
        <Route path="/certifications" element={<NirvahaAcademyPage />} />
        <Route path="/stories" element={<StoriesPage />} />
        <Route path="/success-story/:id" element={<SuccessStoryDetail />} />
        <Route path="/journey/:topicId" element={<JourneyPage />} />
        <Route path="/pathways" element={<Navigate to="/" replace />} />
        <Route path="/pathways/:id" element={<Navigate to="/" replace />} />
        <Route path="/pathways/:id/journey" element={<Navigate to="/" replace />} />
        <Route path="/pathways/:id/syllabus" element={<Navigate to="/" replace />} />
